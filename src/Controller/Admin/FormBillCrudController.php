...
class FormBillCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        if (Crud::PAGE_INDEX === $pageName) {
            return [$groupLayout, $booker, $firstName, $lastName, $payments, $payed, $payedPayconiq];
            ...
            return [$payments, $payed, $payedPayconiq];
